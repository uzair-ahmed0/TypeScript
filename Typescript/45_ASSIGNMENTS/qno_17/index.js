...
of your program*/
var guestList = ["Uzair", "Subhan", "Hashir"];
// Print Message
console.log("Unfortunately! the new diner table wont arrive so we can invaite only 2 guest ");
...
guestList.forEach(function (guest) {
    console.log("Dear ".concat(guest, ", you both are invited the dinner"));
});
